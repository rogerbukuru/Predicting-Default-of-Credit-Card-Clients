...
s3d_pca = scatterplot3d(x = pca_scores$PC1, y = pca_scores$PC2, z = pca_scores$PC3, main = "Principal Components K-Means Clusters",
...
kmeans_result_vae <- kmeans(encoded_points_vae, centers = 4, nstart = 25)
 ...
 s3d_vae = scatterplot3d(x = encoded_points_vae$V1, y = encoded_points_vae$V2, z = encoded_points_vae$V3, main = "Variational Autoencoder 3D Embedding of K-Means Clusters", xlab = "Dim 1", ylab = "Dim 2", zlab = "Dim 3", pch = 19, color = point_colors_ae, cex.axis = 0.5)
# Add a legend
# Adjust the position based on your plot's scale
