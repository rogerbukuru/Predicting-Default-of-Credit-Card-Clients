...
for (k in unique(clusters_pca)) {
  ...
  # Train the SVM model
  svm_models_pca[[k]] <- svm(x = cluster_training_data_pca[, -c(14:27)], y = cluster_training_labels_pca, kernel = "radial", cost = 2, gamma = 0.1)
...
for (k in unique(clusters_ae)) {
  ...
  # Train the SVM model
  svm_models_ae[[k]] <- svm(x = cluster_training_data_ae[, -13], y = cluster_training_labels_ae, kernel = "radial", cost = 2, gamma = 0.1)
