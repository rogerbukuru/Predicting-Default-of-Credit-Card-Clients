...
encoded_points = ae_encoded_points(
  autoencoder_result[[1]]$autoencoder_model,
  autoencoder_result[[1]]$input_layer,
  autoencoder_result[[1]]$encoder,
  code_size = 1,
  training_data_x_std_smote)
...
kmeans_result_ae <- kmeans(encoded_points, centers = 3, nstart = 25)
 ...
 cluster_colors_ae <- c("#0799BC", "darkgreen", "#F98524", "#F1EA81","#222222")  # Specify colors for each cluster
 point_colors_ae <- cluster_colors_ae[kmeans_result_ae$cluster]
 
 scatterplot3d(x = encoded_points$V1, y = encoded_points$V2, z = encoded_points$V3, main = "Autoencoder 3D Embedding", xlab = "Dim 1", ylab = "Dim 2", zlab = "Dim 3", pch = 19, color = point_colors_ae, cex.axis = 0.5)
