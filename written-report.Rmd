...
scatterplot3d(x = classic$x[,1], y = classic$x[,2], z = classic$x[,3], main = "Principal Components",
              xlab = "PC1", ylab = "PC2", zlab = "PC3", pch = 19, color = "blue", cex.axis = 0.5)
...
train_autoencoder = function(epochs = 100) {
  auto_associative <-
  autoencoder_model %>%
  fit(as.matrix(train_X_continous), 
...
for(k in 1:5){
  ...
  autoencoder_mse[k] = autoencoder_mse["loss"]
}
