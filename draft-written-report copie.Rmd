...
train_oversampled_X_categorical = train_oversampled_data %>%
              select(where(is.factor))
train_X_oversampled_categorical = train_oversampled_X_categorical[,-4]
train_X_oversampled_continous = train_oversampled_data %>%
              select(where(is.double))
train_X_oversampled_continous = train_X_oversampled_continous[, -1]

# Standardization
mu_x_continous_oversampled = apply(train_X_oversampled_continous, 2, mean)
sigma_x_continous_oversampled  = apply(train_X_oversampled_continous, 2, sd)

train_X_continous_std_oversampled  = as.matrix(apply(train_X_oversampled_continous, 2, function(train_X_oversampled_continous)((train_X_oversampled_continous - mean(train_X_oversampled_continous))/sd(train_X_oversampled_continous))) %>% as.tibble())
...
embedded_points = encoder_model %>%
                  keras::predict_on_batch(x = as.matrix(train_X_continous_std_oversampled)) %>%
                  as.tibble()
